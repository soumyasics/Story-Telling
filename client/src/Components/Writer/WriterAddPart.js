...
function WriterAddPart() {
  ...
  const handleFileAudioChange = (audio) => {
    ...
    setStoryData({ ...storydata, addaudiopart: audio });
  ...
  const publishStory = async (e) => {
    ...
    try {
      ...
      formData.append("storyId", story_id.id);
      formData.append("partText", storydata.addtextpart);
      formData.append("partAudio", storydata.addaudiopart);
      formData.append("writerId", localStorage.getItem("writer"));

      const response = await axiosMultipartInstance.post(`/addpart`, formData);
      ...
      let msg =
        error?.response?.data?.msg || "Please enter your ideas in part.";
      alert(msg);
    }
  };
        ...
        <div className="container mt-5">
          <div className="writer-story-addpage-navdiv">
            <div className="row">
              ...
              <div className="col-5">
                <button
                  className="mt-4 writer-story-editpage-publishbtn"
